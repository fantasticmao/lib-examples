...
public class ConsumerPull {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Map<MessageQueue, Long/* offset */> offsetMap = new ConcurrentHashMap<>();
        ...
        while (!Thread.currentThread().isInterrupted()) {
            for (MessageQueue mq : queueSet) {
                ...
                switch (pullResult.getPullStatus()) {
                    ...
                    case NO_NEW_MSG -> TimeUnit.MILLISECONDS.sleep(500);
                    case NO_MATCHED_MSG, OFFSET_ILLEGAL -> throw new IllegalStateException();
                }
            }
        }
    }
