...
public class ClassLoaderDemo {
    ...
    /**
     * <tt>BootstrapClassloader</tt> 引导类加载器，又称启动类加载器，是最顶层的类加载器，主要用来加载 Java 核心类，如 rt.jar、resources.jar。
    ...
    /**
     * <tt>ExtClassloader</tt> 扩展类加载器，又称应用加载器，负责加载 Java 的扩展类库，默认加载 JAVA_HOME/jre/lib/ext 目录下所有 jar 包，
    ...
    /**
     * <tt>AppClassloader</tt> 系统类加载器，又称应用加载器，负责在 JVM 启动时加载来自 Java 中的 -classpath 或 java.class.path 系统属性，
